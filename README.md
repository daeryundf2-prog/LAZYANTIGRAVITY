...
| :--- | :--- |
| Single agent, single task | **34 specialized skills** auto-triggered by keywords |
...
> - **Specialized Skills (25 skills)**: Act as the **"Tools/Quality Gates"** called by the engine or triggered automatically by lifecycle hooks.
...
| ![Code Quality](https://img.shields.io/badge/Code_Quality-FBBC05?style=flat-square) | `programming`, `refactor`, `remove-ai-slops`, `review-work`, `comment-checker`, `cjk-cleaner` | Strict types, AI slop removal, post-implementation reviews, comment protection, CJK spacing normalizer |
| ![Digital Forensics & Data Analysis](https://img.shields.io/badge/Forensics_%26_Analysis-0F172A?style=flat-square) | `exif-extractor`, `sqlite-analyzer`, `macb-timeline`, `duplicate-finder` | Metadata & extension spoofing check, SQLite queries/schemas, MACB file event timeline, duplicate file finder |
...
- **34 Specialized Skills**: Includes duplicate file finder, ultraresearch swarms, visual QA, TDD workflows, web cloner, conditional rule synchronization, dynamic skill generators, and more.
...
| [kordoc](https://github.com/chrisryugj/kordoc) | [@chrisryugj](https://github.com/chrisryugj) | OWPML 한글(HWPX) 파서 및 마크다운 역변환 스키마 제어 |
| [undoc](https://github.com/iyulab/undoc) | [@birdnamoo](https://github.com/birdnamoo) | CJK 동적 근접 띄어쓰기 및 텍스트 정제 정규화 규칙 |
| [claw-code-gemini](https://github.com/laothrs/claw-code-gemini) | [@laothrs](https://github.com/laothrs) | Rust 기반 터미널 에이전트 루프 및 제미나이 API 라우팅 |
