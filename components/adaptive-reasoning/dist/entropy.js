 ...
 */
export const POSITIVE_VERDICTS = /\b(가능|성립|일치|존재|합치|정상|통과|유효|인정|true|pass|valid|supported|yes)\b/i;
export const NEGATIVE_VERDICTS = /\b(불가|불성립|불일치|부존재|위반|오류|실패|무효|부인|기각|false|fail|invalid|refuted|no)\b/i;
