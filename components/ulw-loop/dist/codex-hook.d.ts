...
export declare function applyPostCompactRecovery(payload: PostCompactPayload): Promise<string>;
export declare function runUlwLoopHookCli(stdin: NodeJS.ReadableStream, stdout: NodeJS.WritableStream): Promise<void>;
export declare function runPostCompactHookCli(stdin: NodeJS.ReadableStream, stdout: NodeJS.WritableStream): Promise<void>;
