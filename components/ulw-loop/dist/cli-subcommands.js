...
import { hasFlag, parseCaptureEvidenceArgs, parseCodexGoalJson, parseRecordEvidenceArgs, positionalText, readStdin, readValue, } from "./cli-arg-parser.js";
...
export async function captureCommand(repoRoot, argv, json) {
