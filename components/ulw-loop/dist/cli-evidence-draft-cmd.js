...
export async function evidenceDraftCmd(repoRoot, argv, json) {
    ...
    if (json)
        printJson({ ok: true, draftPath: result.draftPath, warnings: result.warnings, envelope: result.envelope });
    else {
