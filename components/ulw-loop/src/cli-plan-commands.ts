...
function required(argv: readonly string[], flag: string): string {
	...
	if (val === undefined || !val.trim()) throw new UlwLoopError(`Missing required argument ${flag}`, "ULW_LOOP_ARG_REQUIRED");
	return val.trim();
}
...
export async function createGoals(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
...
export async function completeGoals(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
...
export async function checkpoint(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
...
export async function steer(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
...
export async function addGoal(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
...
export async function criteria(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
	const goalId = required(argv, "--goal-id");
...
export async function captureEvidence(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
...
export async function reviewBlockers(repoRoot: string, argv: readonly string[], json: boolean, scope?: UlwLoopScope): Promise<number> {
	const codexGoalJson = await parseCodexGoalJson(readValue(argv, "--codex-goal-json"));
