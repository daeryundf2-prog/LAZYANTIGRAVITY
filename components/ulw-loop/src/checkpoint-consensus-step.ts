...
export async function runCheckpointConsensusStep(
	repoRoot: string,
	runId: string,
	fingerprint: string,
	goal: UlwLoopItem,
	...
	const termEvent = updatedEvents.find((e) =>
		(e.type === "quality_gate.consensus_passed" || e.type === "quality_gate.consensus_failed" || e.type === "quality_gate.consensus_rework_required" || e.type === "quality_gate.consensus_inconclusive") &&
