...
export function parseDomainFromUrl(targetUrl: string): string | null {
	try {
...
export function auditEgressRequest(targetUrl: string, customWhitelist?: readonly string[]): EgressAuditResult {
