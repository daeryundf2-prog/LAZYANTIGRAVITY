---
name: boost
description: "Google Antigravity Boost Mode: Deep reasoning, extended planning, multi-perspective swarm discovery, Pro-tier adversarial verification, and evidence-bound claim locking. Triggers: /boost, boost, 부스트, boost 모드, 초정밀 분석, boost mode."
---
...
```mermaid
flowchart TD
    User["사용자 요청: /boost <과업>"] --> Stage1["Stage 1: Extended Cognitive Planning<br/>사고 예산 극대화 & Sequential Thinking"]
    Stage1 --> Stage2["Stage 2: 3-Wave Multi-Perspective Swarm<br/>(Architecture / Benchmark / Adversarial Counter-Search)"]
    Stage2 --> Stage3["Stage 3: Strict Discipline Implementation<br/>(Strict Types, 250 LOC Ceiling, TDD)"]
    Stage3 --> Stage4["Stage 4: Pro-Tier 5-Oracle Gate<br/>(Security, Quality, QA, Visual, Performance - Model: 'pro')"]
    Stage4 --> Stage5["Stage 5: Evidence Ledger Lock<br/>(Claim Ledger + Real-Usage Manual-QA Transcript)"]
    Stage5 --> Done["완료 (Delivery)"]
```
