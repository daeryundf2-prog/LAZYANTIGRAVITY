---
name: programming
description: Use for typed implementation practices and language-specific quality gates.
---

# programming

Use this skill for typed implementation across Python, Rust, TypeScript, and Go. Prefer strict types, focused tests, and native Antigravity file and command tools.
