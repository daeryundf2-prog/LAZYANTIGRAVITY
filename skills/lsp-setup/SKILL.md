---
name: lsp-setup
description: Use for portable language-server detection and configuration guidance.
---

# lsp-setup

Use this skill to detect, configure, and verify language servers. Keep setup local, explicit, and reversible.
