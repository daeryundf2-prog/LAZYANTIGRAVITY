---
name: doctor
description: "Diagnose Antigravity plugin and environment health against project guidelines and toolchain standards. Use whenever the user asks for a doctor or health check, or suspects a stale, drifted, or broken setup."
---
