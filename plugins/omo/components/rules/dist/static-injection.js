...
export function runStaticInjection(cwd, transcriptPath, eventName, cachePath, options, completedPostCompactChannel, transcriptSearchOptions = {}, model) {
    ...
    const effectiveConfig = completedPostCompactChannel === undefined
        ? config
