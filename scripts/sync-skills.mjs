...
const coreBodies = new Map([
	...
	["ulw", "Use this skill for bounded ultrawork execution using native Antigravity collaboration tools, including `invoke_subagent`, `send_message`, and `manage_subagents`."],
