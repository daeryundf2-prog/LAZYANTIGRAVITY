...
test("#given aggregate MCP configs #when status JSON is requested #then local servers are classified", () => {
	...
	assert.deepEqual(
		...
		["ast_grep", "ast_index", "git_bash", "korean_law_offline", "lsp", "media", "research", "workspace"],
	);
	...
	for (const name of ["ast_grep", "ast_index", "git_bash", "korean_law_offline", "lsp", "media", "research", "workspace"]) {
