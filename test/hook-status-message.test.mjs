...
const AGGREGATE_EXPECTED_LABELS = new Map([
	...
	["hooks/hooks.json:UserPromptSubmit:0:0", "Analyzing Prompt Density"],
	["hooks/hooks.json:UserPromptSubmit:1:0", "Amplifying Prompt Constraints"],
	["hooks/hooks.json:UserPromptSubmit:2:0", "Loading Project Rules"],
	["hooks/hooks.json:UserPromptSubmit:3:0", "Checking Ultrawork Trigger"],
	["hooks/hooks.json:UserPromptSubmit:4:0", "Checking Ulw-Loop Steering"],
